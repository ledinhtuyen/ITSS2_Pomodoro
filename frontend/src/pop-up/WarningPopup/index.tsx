...
const WarningPopup = ({ setIsOpenWarningPopup }: WarningPopupProps) => {
  ...
  return (
    <div className="w-screen h-screen fixed inset-0 bg-[rgba(0,0,0,0.5)] z-[101]">
      <div style={{backgroundImage : `url(${WarningPopupBg})`}} className="relative top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-cover bg-no-repeat bg-center w-[884px] h-[461px]">
        <button
