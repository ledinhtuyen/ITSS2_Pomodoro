        ...
        <div className="px-5">
          ...
          <div className="grid grid-cols-4 gap-x-4 gap-y-2">
            {dataPost.map((item: any, index: any) => (
              <div className="cursor-pointer" key={index} onClick={() => navigateToDetailBlog(item.id)} >
            ...
            {dataVideo.map((item: any, index: any) => (
              <div className="cursor-pointer" key={index} onClick={() => navigateToDetailVideo(item.id)} >
