        ...
        <div className="pt-16 pb-10">
          ...
          <div className="font-semibold text-center mt-5">
            ...
            <div className="flex gap-3 justify-center mt-3">
              <div
                className={clsx(
                  like === true ? "bg-blue-500" : "",
                  "w-[49px] h-[49px] rounded-full text-center border-[2px] border-black leading-[42px]  hover:cursor-pointer"
                )}
                onClick={toggleLike}
              >
                <LikeOutlined />
              </div>
              <div className="w-[49px] h-[49px] rounded-full text-center border-[2px] border-black text-2xl leading-[42px]">
                {likes}
              </div>
            </div>
          </div>
